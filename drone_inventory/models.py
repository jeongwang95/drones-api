...
class Drone(db.Model):
    ...
    def __init__(self, name, description, price, camera_quality, flight_time, max_speed, dimensions, weight, cost_of_prodection, series, random_joke, user_token, id=''):
        self.id = self.set_id()
        self.name = name
        ...
        self.weight = weight
        self.cost_of_production = cost_of_prodection
        self.series = series
